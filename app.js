...
console.log("Location Coordinate = [%d,%d]",lat )
  }
...
function initMap() {
     ...
     //  var origin1 = 'abac huamak';
     var origin1 = {lat: 55.93, lng: -3.118};
     var destinationA = {lat:13.744868,lng: 100.533903};
            ...
            for (var i = 0; i < originList.length; i++) {
              ...
              for (var j = 0; j < results.length; j++) {
                ...
                outputDiv.innerHTML += originList[i] + ' to ' + destinationList[j] +
                 ...
                 var DisDuObj = {distance : {
                     Disnumber0 : "Initial Distance"
                                            
                    } ,                
                 duration:{
                     Dunumber0 :  "Initial Duration"
                 } };
                  // Distance,Duration to Var
            var newDisnumber = "Disnumber" + (j+1);
            var newDisvalue = results[j].distance.text;
            var newDunumberr = "Dunumber" + (j+1);
            var newDuvalue = results[j].duration.text;
                
            DisDuObj.distance[newDisnumber] = newDisvalue;
            DisDuObj.duration[newDunumberr] = newDuvalue;
              }
            }
//
...
connection.connect();
var sql = "INSERT INTO MapData(Duraion,Distance) VALUES ("+newDisvalue+","+newDuvalue+") ";
connection.query(sql, function(err) {
    if (err) throw err;
   connection.end();
});
          ...
          //    console.log(JSON.stringify(Myarray));
              console.log(JSON.stringify(DisDuObj));
          }
        });
      }
