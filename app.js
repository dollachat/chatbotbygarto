...
// All function will code below here
// 
//
//
//
...
console.log("Just Duration = "+ justduration[0]);
pushtodatabase(justdistance[0],justduration[0]);
}
...
connection.connect();
var sql = "INSERT INTO MapData(Duration,Distance) VALUES ("+justduration+","+justdistance+")";
 connection.query(sql, function(err) {
    if (err) throw err;
    connection.end();
});
